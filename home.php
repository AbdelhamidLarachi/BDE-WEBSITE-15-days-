...
if(!isset($_SESSION["uid"])){
  header("location:idea_visitor.php");
}
?>
<!DOCTYPE html>
<html>
...
<form name="form3" method="post" action="insertIdea.php" >
  <table width="50%">
    <tr>
      ...
      $checkRole = $_SESSION['role'];
?>
      <td><input style='border-radius: 5px; position: relative; left: 160px; width: 450px; height: 30px; border-bottom: 2px solid #5D77FE;' placeholder="Evenement Title" name="ideaHeadline" type="text" id="ideaHeadline" required></td>
    </tr>
    <tr> 
      <td><textarea style='border-radius: 5px; position: relative; left: 160px; width: 450px; height: 60px; border: 2px solid #5D77FE;' placeholder="Description" name="ideaStory" id="ideaStory" required></textarea></td>
    </tr>
    <?
$checkRole = $_SESSION['role'];
if ($checkRole == 3) {
  ?>
    ...
    <tr><td><select  style='border-radius: 5px; position: relative; left: 160px; width: 120px; height: 20px; border-bottom: 2px solid #5D77FE;' id="ideaStyle" name="ideaStyle">
       <option name="---" value="---">---</option>
      <option name="Punctual" value="Punctual">Punctual</option>
      <option name="Recurrent" value="Recurrent">Recurrent</option>
    </select></td>
        <td><select style='border-radius: 5px; position: relative;right: 160px; width: 120px; height: 20px; border-bottom: 2px solid #5D77FE;' name="ideaFee">
                 <option name="---" value="---">---</option>
      <option name="Free" value="Free">Free</option>
      <option name="Payable" value="Payable">Payable</option>
      <option name="Profitable" value="Profitable">Profitable</option>
    </select></td>    <td>

    <input type="datetime-local" style='width: 190px; border-radius: 5px; position: relative;right: 150px; border-bottom: 2px solid #5D77FE;' id="meetingTime" name="meetingTime" value="2018-06-12T19:30">
    <?
}
    ?>
<tr><td><select  style='visibility: hidden; display:inline; border-radius: 5px; position: relative; left: 160px; width: 120px; height: 20px; border-bottom: 2px solid #5D77FE;' id="ideaStyle" name="ideaStyle">
       <option name="---" value="---">---</option>
      <option name="Punctual" value="Punctual">Punctual</option>
      <option name="Recurrent" value="Recurrent">Recurrent</option>
    </select></td>
        <td><select style='visibility: hidden; border-radius: 5px; position: relative;right: 170px; width: 120px; height: 20px; border-bottom: 2px solid #5D77FE;' name="ideaFee">
                 <option name="---" value="---">---</option>
      <option name="Free" value="Free">Free</option>
      <option name="Payable" value="Payable">Payable</option>
      <option name="Profitable" value="Profitable">Profitable</option>
    ...
    <input type="datetime-local" style='visibility: hidden; border-radius: 5px; position: relative;right: 160px; border-bottom: 2px solid #5D77FE;' id="meetingTime" name="meetingTime" value="2018-06-12T19:30">
</td></tr><tr><td><input type="hidden" name="ideaUserID" value="<?php echo $_SESSION['uid']; ?>" />
</td></tr><tr><td><input type="hidden" name="ideaUserName" value="<?php echo $_SESSION['name']; ?>" />
</td></tr><tr><td><input type="hidden" name="ideaUserCampus" value="<?php echo $_SESSION['address2']; ?>" />
</td></tr><tr><td><input type="hidden" name="ideaUserEmail" value="<?php echo $_SESSION['email']; ?>" />
</td></tr>
</td></tr>
    <tr> 
      <td colspan="2"><div id="test" align="center">
          <input style='border-radius: 5px; position: relative; left: 100px; width: 450px; height: 40px; bottom: 10px;' 
          name="Share" type="submit" id="Share" value="Share">
        </div></td>
    </tr>
  </table>
  </form>
...
</td></tr><tr><td><input type="hidden" name="voteUserCampus" value="<?php echo $_SESSION['campus']; ?>" />
...
<form id='approveIdea' method="post" action='approveIdea.php'>
<input type="hidden" name="ideaID" value="<?php echo $row['ideaID']; ?>" />
<input style=" margin: 10px; border-radius: 10px;  border: 2px solid #5D77FE; background-color: white;" type="submit" id="approveIdea" name="approveIdea" value="✓︎ Approve" onsubmit="approveIdea()" />
</form>
<?
}
if ($checkRole == 2) {
