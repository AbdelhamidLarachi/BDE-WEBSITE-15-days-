...
$product_commande_query = "SELECT * FROM products ORDER BY product_commande DESC LIMIT 3";
$run_my_query = mysqli_query($con,$product_commande_query);
if(mysqli_num_rows($run_my_query) > 0){

 while($row = mysqli_fetch_array($run_my_query)){
   ...
   <div class='col-md-4'>
      <div class='panel panel-info'>
       ...
       <div class='panel-heading'>$.$pro_price.00
        <button pid='$pro_id' style='float:right;' id='product' class='btn btn-success btn-xs'>Ajouter au pannier</button>
       </div>";
       			                 if(isset($_SESSION["uid"])){
 if ($checkRole == 3) {

          echo" <div class='panel-heading'>*
        <a href='Delete.php?id=$pro_id' style='text-decoration: none;'><button style='float:right;'  class='btn btn-danger btn-xs'>Suprimmer</button></a></div>";
    }}
      echo"</div></div>";
